const translations = {
  it: {
    ...
    "services.subtitle":
      "Percorsi per chi ha gia provato soluzioni frammentate. L obiettivo e uscire dal ciclo \"sto meglio, ricado, ricomincio\" e tornare autonomi.",
    ...
    "services.cards.1.title": "Postura e lavoro ad alta responsabilita",
    "services.cards.1.body": "Per chi vive sotto carico mentale e vuole continuita e controllo.",
    ...
    "about.body":
      "Osteopata e laureando in Fisioterapia. Lavoro con professionisti e imprenditori che vogliono capire perche il problema torna e uscire dal ciclo delle ricadute.",
    ...
    "method.subtitle": "Gia dalla prima visita capisci perche finora non ha funzionato e cosa serve per risolvere.",
    "method.cards.0.title": "1. Valutazione reale",
    "method.cards.0.body": "Analisi del movimento e delle cause, non solo del sintomo.",
    "method.cards.1.title": "2. Terapia manuale mirata",
    "method.cards.1.body": "Usata quando serve, integrata nel percorso.",
    "method.cards.2.title": "3. Lavoro attivo guidato",
    ...
    "reviews.cards.0.body":
      "\"Imprenditore, viaggi continui: avevo ricadute ogni mese. Ora ho un percorso chiaro e la schiena e affidabile.\"",
    "reviews.cards.0.author": "Marco, 42",
    "reviews.cards.1.body":
      "\"Manager con agenda piena. Ho capito il perche del problema e cosa fare per non ripartire da capo.\"",
    ...
    "contact.subtitle": "Rispondo entro 24 ore. Compila il form oppure chiamami direttamente.",
    "contact.form.name": "Nome e cognome",
    "contact.form.email": "Email",
    "contact.form.phone": "Telefono",
    "contact.form.message": "Messaggio",
    "contact.form.cta": "Prenota visita",
    "contact.form.note": "* Il form e solo dimostrativo.",
    ...
    "contact.info.whatsappMsg": "Ciao Federico, vorrei avere piu informazioni",
    "contact.info.map": "Inserisci qui la mappa o un iframe.",
    "faq.eyebrow": "FAQ",
    ...
    "faq.a2": "Si. Il percorso richiede partecipazione attiva. La terapia manuale da sola non basta per risolvere.",
    ...
    "faq.q4": "Quanto costa?",
    "faq.a4": "La prima visita di valutazione e di 100€. Il percorso viene definito insieme in base all'obiettivo.",
  ...
  en: {
    ...
    "contact.subtitle": "I reply within 24 hours. Fill out the form or call me directly.",
    "contact.form.name": "Full name",
    "contact.form.email": "Email",
    "contact.form.phone": "Phone",
    "contact.form.message": "Message",
    "contact.form.cta": "Book a visit",
    "contact.form.note": "* This form is a demo only.",
    ...
    "contact.info.map": "Insert a map or iframe here.",
    "faq.eyebrow": "FAQ",
...
const applyLanguage = (lang) => {
  ...
  // Update WhatsApp link with language-specific message
  if (whatsappLink && dict["contact.info.whatsappMsg"]) {
    const message = encodeURIComponent(dict["contact.info.whatsappMsg"]);
    whatsappLink.href = `https://wa.me/393755153273?text=${message}`;
  }
