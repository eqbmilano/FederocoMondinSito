/**
 * Testi del sito, IT ed EN. Sta in un file a parte (non client) perche' li usano
 * anche la generazione di llms.txt e dell'export in markdown, che girano lato
 * server durante il build.
 */
